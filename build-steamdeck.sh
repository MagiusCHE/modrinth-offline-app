...
if command -v pkg-config &> /dev/null; then
    ...
    check_pkg_config "xtst" "libxtst" "libxtst-dev"
    ...
    # ATK and accessibility dependencies
    check_pkg_config "libsystemd" "systemd-libs" "libsystemd-dev"
    check_pkg_config "dbus-1" "dbus" "libdbus-1-dev"
    check_pkg_config "atspi-2" "at-spi2-core" "libatspi2.0-dev"
    check_pkg_config "atk" "atk" "libatk1.0-dev"
    check_pkg_config "atk-bridge-2.0" "at-spi2-core" "libatk-bridge2.0-dev"
    ...
    check_pkg_config "sqlite3" "sqlite" "libsqlite3-dev"
    check_pkg_config "libpsl" "libpsl" "libpsl-dev"
    check_pkg_config "libnghttp2" "libnghttp2" "libnghttp2-dev"
